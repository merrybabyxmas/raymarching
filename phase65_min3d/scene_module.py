...
class SceneModule(nn.Module):
    ...
    def __init__(
        ...
        self.motion = MotionRollout(slot_dim=slot_dim, hidden_dim=hidden_dim)
    ...
    def forward(
        ...
        layout_e0, layout_e1 = self.motion(slot_e0, slot_e1, mem_e0, mem_e1, t_index=t_index)
        raw_v0, raw_h0, raw_d0, feat_e0 = self.decoder(slot_e0, mem_e0, layout_e0)
        raw_v1, raw_h1, raw_d1, feat_e1 = self.decoder(slot_e1, mem_e1, layout_e1)
