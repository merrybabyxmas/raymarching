...
def train(args):
    ...
    print(f"[Phase 28] LoRA-based text attn (rank=4, fp32), lambda_attn={args.lambda_attn}",
          flush=True)
    ...
    print(f"[p28] LoRA attn2 (q_dim={q_dim}, ctx={context_dim}, rank=4): "
...
def parse_args():
    ...
    p.add_argument("--save-dir",     default="checkpoints/phase28",    dest="save_dir")
    p.add_argument("--debug-dir",    default="debug/train_phase28",    dest="debug_dir")
